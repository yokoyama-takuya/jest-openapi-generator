...
module.exports = class Reporter {
    constructor(_, opts) {
        this.output = opts === null || opts === void 0 ? void 0 : opts.output;
        this.silent = opts === null || opts === void 0 ? void 0 : opts.silent;
    }
    onRunComplete() {
        let template;
        try {
        ...
        try {
            ...
            fs.readdirSync(temporaryPath).forEach(file => {
                ...
                template.paths = Object.assign(Object.assign({}, template.paths), path);
            });
